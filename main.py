...
MODS = {
    ...
    "FramedBlocks-9.4.2.jar": "https://poluxsupershark.net/mods/FramedBlocks-9.4.2.jar",
    ...
    "tfmg-1.0.2e.jar": "https://poluxsupershark.net/mods/tfmg-1.0.2e.jar",
